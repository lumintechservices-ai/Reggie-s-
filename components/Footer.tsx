      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            <h2 className="text-3xl font-bold font-serif text-brand-primary">Reggie's Signature Plates</h2>
            <p className="text-gray-400 text-base">
              Authentic pasta and noodles, crafted with locally sourced ingredients and delivered to your doorstep in Abuja.
            </p>
          ...
          <div className="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
            ...
            <div className="md:grid md:grid-cols-1 md:gap-8">
               <div>
                ...
                <p className="text-gray-400 mt-4">Subscribe for updates and exclusive offers.</p>
                 <form className="mt-4 sm:flex sm:max-w-md">
                    ...
                    <div className="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
                      <button type="submit" className="w-full bg-brand-primary border border-transparent rounded-md py-2 px-4 flex items-center justify-center text-base font-medium text-white hover:bg-brand-primary/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-brand-primary">
                        Subscribe
                      </button>
                    </div>
                  </form>
        ...
        <div className="mt-12 border-t border-gray-700 pt-8">
          <p className="text-base text-gray-400 xl:text-center">&copy; {new Date().getFullYear()} Reggie's Signature Plates. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
